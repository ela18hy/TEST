...
class Arc_item(QGraphicsLineItem):
    def __init__(self):
        super(Arc_item, self).__init__()

        #QLineF相当于一个坐标定位器，定位一个点 （x,y）
        # The start point at (0,0) #线的起始点 
        self.start = QPointF(50, 50)

        # The coordinate (120,120)
        self.end = QPointF(120, 120)

        # Draw Qline  (0,250 to 120,120) 一条从（50,50）到 （120,120）的线 
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        arc2 = Arc_item()
        self.graphicsscene.addItem(arc2)
